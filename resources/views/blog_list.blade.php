                        ...
                        <div class="col-md-12">
                            <div class="topbar-home2">
                                <div class="tb-contact tb-iconbox">
                                    <ul>
                                        <li><a href="https://www.google.co.id/maps/place/Jl.+Terusan+Halimun+No.50,+Lkr.+Sel.,+Kec.+Lengkong,+Kota+Bandung,+Jawa+Barat+40263"><i class="fa fa-map-marker"
                                                    aria-hidden="true" target="_blank"></i><span><i>Find us</i> Jl. Terusan Halimun No.
        ...
        <section class="no-padding sh-news">
            <div class="sub-header ">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active"> {{ __('messages.menu_article') }}</li>
                </ol>
            </div>
        </section>
        <!-- /subheader -->
                        ...
                        <div class="col-md-6">
                            <div class="item-new-list grid-new">
                                ...
                                <div class="feature-new-warp">
                                    <a href="/blog/{{ $item->id }}">
                                        <img src="storage/{{ $item->post_image_thumb }}" class="img-responsive"
                                            alt="Image">
                                    </a>
                                </div>
                                <div class="box-new-info">
                                    <div class="new-info">
                                        <h4>
                                            <a href="/blog/{{ $item->id }}">{{ $item->post_title }}</a>
                                        </h4>
                                        <p><i class="fa fa-calendar"
                                                aria-hidden="true"></i>{{ date('d, M Y', strtotime($item->created_at)) }}
                                        </p>
                                        <p><i class="fa fa-user" aria-hidden="true"> </i> {{ $item->user->name }}</p>
                                    </div>
                                    <div class="tapo">
                                        <p>{{ $item->post_summary }}</p>
                                    </div>
                                    <a href="/blog/{{ $item->id }}" class="ot-btn btn-sub-color">Read More</a>
                                </div>
                            </div>
                        </div>
                        @endforeach
